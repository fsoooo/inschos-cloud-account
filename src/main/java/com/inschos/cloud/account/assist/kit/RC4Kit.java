package com.inschos.cloud.account.assist.kit;
...
public class RC4Kit {
     ...
     * 解密十六进制密文
     */
    public String decry_RC4_hex(String data) {
        if (data == null) {
            return null;
        }
    ...
    public String decry_RC4_base64(String data) {
        if (data == null) {
            return null;
        }
        return new String(RC4Base(Base64.getDecoder().decode(data)));
    }
    ...
    public String encry_RC4_base64(String data) {
        if (data == null) {
            return null;
        }

        return Base64.getEncoder().encodeToString(encry_RC4_byte(data));
    }

    /**
     * 加密为十六进制密文
     */
    public String encry_RC4_hex(String data) {
        if (data == null) {
            return null;
        }
    ...
    private synchronized byte[] RC4Base(byte[] input, int offset, int length) {
        int x = 0;
        int y = 0;
        int xorIndex;
